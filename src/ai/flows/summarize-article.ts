'use server';
/**
 * @fileOverview Summarizes an article from a given URL.
 *
 * - summarizeArticle - A function that summarizes an article from a URL.
...
const SummarizeArticleInputSchema = z.object({
  url: z.string().describe('The URL of the article to summarize.'),
});
